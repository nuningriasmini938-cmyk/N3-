...
const STORAGE_QUESTIONS_KEY = 'sd3_loloan_timur_questions_k2_v1';
...
export default function App() {
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Pastikan jumlah dan struktur sesuai dengan distribusi soal terbaru (15 soal: 10 PG, 5 Benar Salah)
  ...
  // Reset soal ke 15 butir standar Kelas 2 (10 PG, 5 Benar Salah)
